    ...
    <nav className="bg-gray-800">
      ...
      <div className={`md:hidden ${isOpen ? 'block' : 'hidden'}`}>
        <div className="px-2 pt-2 pb-3 space-y-1 flex flex-col gap-4">
            ...
            <button className='w-fit bg-orange-600 text-black caption-bottom font-medium border-transparent rounded-3xl px-6 py-2 hover:bg-transparent hover:text-orange-600 hover:border-orange-600 transition-all'>login</button>
        </div>
      </div>
    </nav>
  );
